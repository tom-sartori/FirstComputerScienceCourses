...
import static simcitree.jfxutils.JFXUtil.getXShift;
import static simcitree.jfxutils.JFXUtil.getYShift;
...
public class XYChartInfo {
	 ...
	 * system.
	 */
	public XYChartInfo( ScatterChart<?, ?> chart, Node referenceNode ) {
		this.chart = chart;
	 ...
	 */
	public XYChartInfo( ScatterChart<?, ?> chart ) {
		this( chart, chart );
	}
