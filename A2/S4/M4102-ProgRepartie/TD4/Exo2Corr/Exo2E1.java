...
public class Exo2E1 {
    ...
    public static void etape1(){
        ...
        Semaphore semaphore3 = new Semaphore(0,true);
        ATache t1 = new ATache(1, semaphore1, semaphore2);
        ATache t2 = new ATache(2, semaphore2, semaphore3);
        ATache t3 = new ATache(3, semaphore3, semaphore1);
